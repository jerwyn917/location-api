...
import { SeederTemplate } from './code_templates/SeederTemplate';
import { MiddlewareTemplate } from './code_templates/MiddlewareTemplate';
...
try {
    ...
    commands.command(
        ...
        () => {},
        (argv: Arguments) => {
            const template = new SeederTemplate(<string>argv.name);
            template.generate();

            console.log('Seeder successfully created');
        },
    );
    ...
    commands.command(
        ...
        () => {},
        (argv: Arguments) => {
            const template = new MiddlewareTemplate(<string>argv.name);
            template.generate();

            console.log('Middleware successfully created');
        },
    );
