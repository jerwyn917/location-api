...
`;
    handler = `
import { Databases } from '<backward>../../../libs/Mysql';
import { API_RESPONSE, THROW_API_ERROR } from '<backward>../../../libs/Response';
import { APIHttpResponse } from '<backward>../../../libs/Contracts/APIHttpResponse';
import { ApiGatewayEvent } from '<backward>../../../libs/Contracts/ApiGatewayEvent';
...
`;
    responses = `
import { HttpResponse } from '<backward>../../../libs/Contracts/HttpResponse';
...
`;
    validate = `
import { Validation } from '<backward>../../../libs/Validation';
import { joi } from '<backward>../../../libs/Joi';
import { <request_name> } from './requests';
...
`;
    requests = `
import { HttpRequest } from '<backward>../../../libs/Contracts/HttpRequest';
